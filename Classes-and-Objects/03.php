<?php
/*
for this exercise, you will design a set of classes that work together to simulate a car's
...
To be able to work with a FuelGauge object. It should decrease the FuelGauge object’s current
amount of fuel by 1 liter for every 10 kilometers traveled. (The car’s fuel economy is 10 kilometers per liter.)
...
$odometer = new Odometer(999667, $fuelGauge);
...
while ($fuelGauge->getFuel() > 0) {
    ...
    echo "Mileage: {$odometer->getMileage()} km. Fuel: {$fuelGauge->getFuel()} liters\n";
}

echo "The car has run out of fuel.\n";